...
// @grant       none
// @version     1.5
// @author      Nguyen Hao (Refactored by AI, Enhanced by AI), telegram: @xhkvx
// @description Refactored version of Google One Toolkit with further UI/UX enhancements including a minimize button and selection highlighting.
// ==/UserScript==
...
(function () {
  ...
  const PACKAGE_OPTIONS_CONFIG = {
    "MONTHLY": ["No change", "100gb", "200gb", "2tb", "2tb.ai", "5tb", "10tb", "20tb", "30tb", "ai.pro.3months_ip_50p"],
    "YEARLY": ["100gb.annual", "200gb.annual", "2tb.annual", "5tb.annual"],
  ...
  const UI_TEXT = {
    ...
    minimizeButtonArialabel: "Minimize window",
    restoreButtonArialabel: "Restore window",
    tokenInputLabel: "Enter or paste the token snippet manually:",
    tokenInputPlaceholder: "Token will auto-populate if found...",
    cPercentSectionTitle: "Choose replacement method (C%):",
    packageSectionTitle: "Choose package code to replace:",
    currentLabel: "Current:",
    replacementLabel: "Replacement:",
    copyButton: "Copy Token",
    openLinkButton: "Open Token Link",
    noChangeOption: "No change",
    toastCopied: "Copied to clipboard!",
    toastCopyError: "Copy error: ",
    toastNoTokenToCopy: "No token to copy.",
    toastInvalidUrl: "Token is not a valid URL to open.",
    toastTokenDetected: "Token automatically detected and updated!",
    toastNewTokenOnPage: "New token detected on the page!",
    errorInvalidToken: "The token snippet is invalid.",
    errorNoOriginalToken: "No valid original token found.",
    errorProcessingToken: "Cannot process token with this selection or the original token is invalid.",
  };

  const TAB_TITLES_MAP = {
    "MONTHLY": "Monthly Package Codes",
    "YEARLY": "Yearly Package Codes",
    "100GB": "100GB Trial Codes",
    "200GB": "200GB Trial Codes",
    "2TB": "2TB Trial Codes"
  };
  const DEFAULT_TAB_KEY = "MONTHLY";
  const TWO_COLUMN_TAB_KEY = "MONTHLY";
  ...
  function showToastNotification(message, type = "info") {
    ...
    const toastId = `toast-<span class="math-inline">\{Date\.now\(\)\}\-</span>{Math.random().toString(36).substring(2, 7)}`;
  ...
  function updatePanelFooterStatus() {
    ...
    statusDiv.innerHTML = `
      <div class="g1tp-footer-status-line"><span class="math-inline">\{UI\_TEXT\.currentLabel\} <b\></span>{currentPackage}</b> / <b><span class="math-inline">\{currentCPercent\}</b\></div\>
<div class\="g1tp\-footer\-status\-line"\></span>{UI_TEXT.replacementLabel} <b><span class="math-inline">\{replacementPackage\}</b\> / <b\></span>{replacementCPercent}</b></div>
    `;
